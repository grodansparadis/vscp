...
#define CANAL_APOX_DRIVER_MAX_OPEN	256
...
public:
	...
	*/
	long addDriverObject( CApoxObj *pObj );
	...
	/*!
		...
		@return pointer to object or NULL if invalid
				handle.
	*/
	CApoxObj *getDriverObject( long h );
	...
	*/
	CApoxObj *m_drvObjArray[ CANAL_APOX_DRIVER_MAX_OPEN ];
