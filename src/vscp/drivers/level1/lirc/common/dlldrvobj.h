...
#define CANAL_LIRC_DRIVER_MAX_OPEN	16
...
public:
	...
	*/
	long addDriverObject( CLircObj *pObj );
	...
	/*!
		...
		@return pointer to object or NULL if invalid
				handle.
	*/
	CLircObj *getDriverObject( long h );
	...
	*/
	CLircObj *m_drvObjArray[ CANAL_LIRC_DRIVER_MAX_OPEN ];
