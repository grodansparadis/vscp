...
// Modified by:
// Created:     11/6/98
// RCS-ID:      $Id: automtn.cpp,v 1.1 2005/03/01 13:23:11 akhe Exp $
...
static void ReleaseVariant(VARIANTARG *pvarg)
{
	...
	else 
	{
		switch (vt) 
		{
			...
			case 0:		// to avoid erroring on an error return from Word-2000 
				break;

			case VT_I4:  // to avoid erroring on an error return from Excel
            break;
