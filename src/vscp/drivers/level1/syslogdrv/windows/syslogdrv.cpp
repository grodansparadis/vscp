//
// syslogdrv.cpp : Defines the entry point for the DLL application.
//
...
//
// $RCSfile: syslogdrv.cpp,v $                                       
// $Date: 2005/08/01 10:20:15 $                                  
// $Author: akhe $                                              
// $Revision: 1.2 $ 
...
#endif
{
	...
	CSysLogObj *pdrvObj = new CSysLogObj();
	if ( NULL != pdrvObj ) {
...
#endif
{
	...
	CSysLogObj *pdrvObj =  theApp->getDriverObject( handle );
