...
#define CANAL_SYSLOG_DRIVER_MAX_OPEN	1
...
public:
	...
	*/
	long addDriverObject( CSysLogObj *pObj );
	...
	/*!
		...
		@return pointer to object or NULL if invalid
				handle.
	*/
	CSysLogObj *getDriverObject( long h );
	...
	*/
	CSysLogObj *m_drvObjArray[ CANAL_SYSLOG_DRIVER_MAX_OPEN ];
