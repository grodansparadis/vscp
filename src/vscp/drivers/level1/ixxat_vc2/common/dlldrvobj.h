...
#define CANAL_IXXATVCI_DRIVER_MAX_OPEN	256
...
public:
	...
	*/
	long addDriverObject( CIxxObj *pObj );
	...
	/*!
		...
		@return pointer to object or NULL if invalid
				handle.
	*/
	CIxxObj *getDriverObject( long h );
	...
	*/
	CIxxObj *m_drvObjArray[ CANAL_IXXATVCI_DRIVER_MAX_OPEN ];
