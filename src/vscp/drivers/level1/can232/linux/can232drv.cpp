...
long CCan232drvdllApp::addDriverObject( CCAN232Obj *plog )
{
	long h = 0;
...
CCAN232Obj * CCan232drvdllApp::getDriverObject( long h )
{
	long idx = h - 1681;
...
void CCan232drvdllApp::removeDriverObject( long h )
{
	long idx = h - 1681;
...
BOOL CCan232drvdllApp::InitInstance() 
{
	m_instanceCounter++;
	return TRUE;
}
