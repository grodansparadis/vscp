...
#define CANAL_PEAK_DRIVER_MAX_OPEN	256
...
public:
	...
	*/
	long addDriverObject( CPeakObj *pObj );
	...
	/*!
		...
		@return pointer to object or NULL if invalid
				handle.
	*/
	CPeakObj *getDriverObject( long h );
	...
	*/
	CPeakObj *m_drvObjArray[ CANAL_PEAK_DRIVER_MAX_OPEN ];
