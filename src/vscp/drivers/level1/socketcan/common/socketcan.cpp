///////////////////////////////////////////////////////////////////////////////
// cansockobjbj.cpp: implementation of the socketcan
//
...
#include "stdio.h"
#include "cansocketobj.h"

// Prototypes
void workThread( void *p );
bool cansocketToCanal( char * p, PCANALMSG pMsg );
...
{
	m_socketcanobj.m_version = -1;	// Version is unknown
	m_socketcanobj.m_bAuto = false;	// Poll mode is default
	m_socketcanobj.m_cntRcv = 0;	// No chars in receive buffer yet
