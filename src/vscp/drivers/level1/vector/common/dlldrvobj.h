...
#define CANAL_VECTOR_DRIVER_MAX_OPEN	256
...
public:
	...
	*/
	long addDriverObject( CVectorObj *pObj );
	...
	/*!
		...
		@return pointer to object or NULL if invalid
				handle.
	*/
	CVectorObj *getDriverObject( long h );
	...
	*/
	CVectorObj *m_drvObjArray[ CANAL_VECTOR_DRIVER_MAX_OPEN ];
