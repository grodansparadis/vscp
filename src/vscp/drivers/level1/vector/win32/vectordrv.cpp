//
// vectordrv.cpp : Defines the entry point for the DLL application.
//
...
#endif
{
	...
	CVectorObj *pdrvObj = new CVectorObj();
	if ( NULL != pdrvObj ) {
...
#endif
{
	...
	CVectorObj *pdrvObj =  theApp->getDriverObject( handle );
