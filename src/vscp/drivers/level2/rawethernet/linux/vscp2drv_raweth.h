// vscp2drv_raweth.h : main header file for the canallogger.dll
// Linux version
//
...
// Driver information.
#define VSCP_RAWETHERNET_DRIVERINFO "<?xml version = \"1.0\" encoding = \"UTF-8\" ?>" \
...
#define VSCP_RAWETHERNET_DRIVER_MAX_OPEN	    256
...
public:
	...
	*/	
	long addDriverObject( CRawEthernet *psockcan );
	...
	*/
	CRawEthernet *m_prawethernetArray[ VSCP_RAWETHERNET_DRIVER_MAX_OPEN ];
