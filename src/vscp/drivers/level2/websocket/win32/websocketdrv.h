...
#ifndef websocketdrv_h
#define Cebsocketdrv_h
...
class CwebsocketdrvTxTread;
class CwebsocketdrvRxTread;
class VscpTcpIf;
...
public:
	...
	/// Server supplied port - prefix_portwebsockets
    short m_portWebsockets;

	/// Base directory - pefix_basedir
	wxString m_dirBase;
    ...
    */
    ...
    CwebsocketdrvTxTread *m_pthreadWorkTx;
    CwebsocketdrvRxTread *m_pthreadWorkRx;
...
/*!
    ...
    from the Ethernet
*/
class CwebsocketdrvTxTread : public wxThread 
{
...
/*!
    ...
    on Ethernet
*/
class CwebsocketdrvRxTread : public wxThread 
{
