//
// websocketdrv.cpp : Defines the entry point for the DLL application.
//
...
#endif
{
	...
	Cwebsocketdrv *pdrvObj = new Cwebsocketdrv();
	if ( NULL != pdrvObj ) {
...
#endif
{
	...
	Cwebsocketdrv *pdrvObj =  theApp->getDriverObject( handle );
...
bool Cwebsocketdrv::open( const char *pUsername,
                            const char *pPassword,
                            const char *pHost,
                            short port,
                            const char *pPrefix,
                            ...
                            unsigned long flags )
{
    ...
    m_pthreadWorkTx = new CwebsocketdrvTxTread();
    ...
    m_pthreadWorkRx = new CwebsocketdrvRxTread();
...
///////////////////////////////////////////////////////////////////////////////
//                            CwebsocketdrvTxTread
///////////////////////////////////////////////////////////////////////////////



CwebsocketdrvTxTread::CwebsocketdrvTxTread()
{
...
void *CwebsocketdrvTxTread::Entry()
{
    pcap_t *fp;
...
void CwebsocketdrvTxTread::OnExit()
{
...
CwebsocketdrvRxTread::CwebsocketdrvRxTread()
{
...
void *CwebsocketdrvRxTread::Entry()
{
    pcap_t *fp;
	char errbuf[ PCAP_ERRBUF_SIZE ];
	uint8_t packet[ 512 ];
...
void CwebsocketdrvRxTread::OnExit()
{
