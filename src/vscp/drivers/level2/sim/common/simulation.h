...
class CWrkTreadObj
{
  public:
     ...
     */
    void doActionReplyTurnOn(vscpEvent *pEvent,
                             uint8_t dmflags,
                             uint8_t dmparam);
    ...
    /*!
        ...
        @param dmparam Decision matrix paramter byte
     */
    void doActionReplyTurnOff(vscpEvent *pEvent,
                              uint8_t dmflags,
                              uint8_t dmparam);
    ...
    uint8_t m_vscp_alarmstatus;
    uint16_t m_vscp_page_select;
...
#endif // !defined(VSCPSIMULATION_H__INCLUDED_)
