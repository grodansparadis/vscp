...
#pragma implementation "readguid.h"
#endif
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// ReadGUID type definition
//

IMPLEMENT_DYNAMIC_CLASS( ReadGUID, wxDialog )


/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// ReadGUID event table definition
//

BEGIN_EVENT_TABLE( ReadGUID, wxDialog )

////@begin ReadGUID event table entries
////@end ReadGUID event table entries

END_EVENT_TABLE()


/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// ReadGUID constructors
//
...
ReadGUID::ReadGUID( wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos, const wxSize& size, long style )
{
  Init();
...
bool ReadGUID::Create( wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos, const wxSize& size, long style )
{
////@begin ReadGUID creation
...
ReadGUID::~ReadGUID()
{
////@begin ReadGUID destruction
////@end ReadGUID destruction
}
...
void ReadGUID::Init()
{
////@begin ReadGUID member initialisation
////@end ReadGUID member initialisation
}


/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Control creation for ReadGUID
//

void ReadGUID::CreateControls()
{    
////@begin ReadGUID content construction
  ReadGUID* itemDialog1 = this;

  wxBoxSizer* itemBoxSizer2 = new wxBoxSizer(wxVERTICAL);
  itemDialog1->SetSizer(itemBoxSizer2);

////@end ReadGUID content construction
}
...
wxBitmap ReadGUID::GetBitmapResource( const wxString& name )
{
  // Bitmap retrieval
////@begin ReadGUID bitmap retrieval
  wxUnusedVar(name);
  return wxNullBitmap;
////@end ReadGUID bitmap retrieval
}
...
wxIcon ReadGUID::GetIconResource( const wxString& name )
{
  // Icon retrieval
////@begin ReadGUID icon retrieval
  wxUnusedVar(name);
