...
////@begin DialogAbstractionEdit content construction
  ...
  itemBoxSizer41->Add(m_singleValueLabel, 0, wxALIGN_CENTER_VERTICAL|wxALL, 1);
  ...
  itemBoxSizer41->Add(m_abstractionValue, 0, wxALIGN_CENTER_VERTICAL|wxALL, 1);

  itemBoxSizer41->Add(20, 1, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);
  ...
  itemBoxSizer45->Add(m_multipleValueLabel, 0, wxALIGN_CENTER_VERTICAL|wxALL, 1);
  ...
  itemBoxSizer45->Add(m_abstractionComboValue, 0, wxALIGN_CENTER_VERTICAL|wxALL, 1);

  itemBoxSizer45->Add(20, 1, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

  wxBoxSizer* itemBoxSizer49 = new wxBoxSizer(wxHORIZONTAL);
  itemBoxSizer2->Add(itemBoxSizer49, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5);
