...
#define SYMBOL_DLGVSCPTRMITELEMENT_SIZE wxSize(400, 300)
...
public:
  /// Constructors
  dlgVSCPTrmitElement();
  dlgVSCPTrmitElement( wxWindow* parent, wxWindowID id = SYMBOL_DLGVSCPTRMITELEMENT_IDNAME, const wxString& caption = SYMBOL_DLGVSCPTRMITELEMENT_TITLE, const wxPoint& pos = SYMBOL_DLGVSCPTRMITELEMENT_POSITION, const wxSize& size = SYMBOL_DLGVSCPTRMITELEMENT_SIZE, long style = SYMBOL_DLGVSCPTRMITELEMENT_STYLE );

  /// Creation
  bool Create( wxWindow* parent, wxWindowID id = SYMBOL_DLGVSCPTRMITELEMENT_IDNAME, const wxString& caption = SYMBOL_DLGVSCPTRMITELEMENT_TITLE, const wxPoint& pos = SYMBOL_DLGVSCPTRMITELEMENT_POSITION, const wxSize& size = SYMBOL_DLGVSCPTRMITELEMENT_SIZE, long style = SYMBOL_DLGVSCPTRMITELEMENT_STYLE );
...
////@begin dlgVSCPTrmitElement event handler declarations
...
////@end dlgVSCPTrmitElement event handler declarations

////@begin dlgVSCPTrmitElement member function declarations
...
////@end dlgVSCPTrmitElement member function declarations

  /// Should we show tooltips?
  static bool ShowToolTips();

////@begin dlgVSCPTrmitElement member variables
...
////@end dlgVSCPTrmitElement member variables
};
