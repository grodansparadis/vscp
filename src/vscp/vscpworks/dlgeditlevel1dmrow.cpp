...
////@begin DialogEditLevelIDMrow event table entries
  EVT_BUTTON( ID_BUTTON_SELECT_EVENTS, DialogEditLevelIDMrow::OnButtonSelectEventsClick )

////@end DialogEditLevelIDMrow event table entries
...
DialogEditLevelIDMrow::DialogEditLevelIDMrow( wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos, const wxSize& size, long style )
{
  Init();
...
bool DialogEditLevelIDMrow::Create( wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos, const wxSize& size, long style )
{
////@begin DialogEditLevelIDMrow creation
  ...
  Centre();
////@end DialogEditLevelIDMrow creation
  return true;
}
...
DialogEditLevelIDMrow::~DialogEditLevelIDMrow()
{
////@begin DialogEditLevelIDMrow destruction
////@end DialogEditLevelIDMrow destruction
}
...
{
////@begin DialogEditLevelIDMrow member initialisation
  m_oaddr = NULL;
  ...
  m_comboAction = NULL;
  m_actionParam = NULL;
////@end DialogEditLevelIDMrow member initialisation
}
...
{    
////@begin DialogEditLevelIDMrow content construction
  ...
  m_chkEnableDMRow->Create( itemDialog1, ID_CHECKBOX_ENABLE_ROW, _("Enable DM row"), wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT );
  m_chkEnableDMRow->SetValue(false);
  itemBoxSizer10->Add(m_chkEnableDMRow, 0, wxALIGN_RIGHT|wxALL, 5);

  m_chkCheckOAddr = new wxCheckBox;
  m_chkCheckOAddr->Create( itemDialog1, ID_CHECKBOX_CHECK_OADDR, _("Check originating address"), wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT );
  m_chkCheckOAddr->SetValue(false);
  itemBoxSizer10->Add(m_chkCheckOAddr, 0, wxALIGN_RIGHT|wxALL, 5);

  m_chkHardOAddr = new wxCheckBox;
  m_chkHardOAddr->Create( itemDialog1, ID_CHECKBOX_HARDCODED_OADDR, _("Originating address should be hardcoded"), wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT );
  m_chkHardOAddr->SetValue(false);
  itemBoxSizer10->Add(m_chkHardOAddr, 0, wxALIGN_RIGHT|wxALL, 5);

  m_chkMatchZone = new wxCheckBox;
  m_chkMatchZone->Create( itemDialog1, ID_CHECKBOX_MATCH_ZONE, _("Zone should match"), wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT );
  m_chkMatchZone->SetValue(false);
  itemBoxSizer10->Add(m_chkMatchZone, 0, wxALIGN_RIGHT|wxALL, 5);

  m_chkMatchSubzone = new wxCheckBox;
  m_chkMatchSubzone->Create( itemDialog1, ID_CHECKBOX_MATCH_SUBZONE, _("Subzone should match"), wxDefaultPosition, wxDefaultSize, wxALIGN_RIGHT );
  ...
  m_comboAction->Create( itemDialog1, ID_COMBOCTRL_ACTION, wxEmptyString, wxDefaultPosition, wxSize(250, -1), m_comboActionStrings, wxCB_READONLY );
...
////@end DialogEditLevelIDMrow content construction
}
...
{
  // Bitmap retrieval
////@begin DialogEditLevelIDMrow bitmap retrieval
  wxUnusedVar(name);
  return wxNullBitmap;
////@end DialogEditLevelIDMrow bitmap retrieval
}
...
{
  // Icon retrieval
////@begin DialogEditLevelIDMrow icon retrieval
  wxUnusedVar(name);
  ...
  return wxNullIcon;
////@end DialogEditLevelIDMrow icon retrieval
}
