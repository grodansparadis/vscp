...
#pragma implementation "writeregister.h"
#endif
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// WriteRegister type definition
//

IMPLEMENT_DYNAMIC_CLASS( WriteRegister, wxDialog )


/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// WriteRegister event table definition
//

BEGIN_EVENT_TABLE( WriteRegister, wxDialog )

////@begin WriteRegister event table entries
////@end WriteRegister event table entries

END_EVENT_TABLE()


/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// WriteRegister constructors
//
...
////@begin WriteRegister creation
  ...
  Centre();
////@end WriteRegister creation
  return true;
}


/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// WriteRegister destructor
//

WriteRegister::~WriteRegister()
{
////@begin WriteRegister destruction
////@end WriteRegister destruction
}
...
{
////@begin WriteRegister member initialisation
////@end WriteRegister member initialisation
}


/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Control creation for WriteRegister
//

void WriteRegister::CreateControls()
{    
////@begin WriteRegister content construction
  WriteRegister* itemDialog1 = this;

  wxPanel* itemPanel2 = new wxPanel;
  itemPanel2->Create( itemDialog1, ID_PANEL38, wxDefaultPosition, wxDefaultSize, wxSUNKEN_BORDER|wxTAB_TRAVERSAL );

  wxBoxSizer* itemBoxSizer3 = new wxBoxSizer(wxVERTICAL);
  itemPanel2->SetSizer(itemBoxSizer3);

////@end WriteRegister content construction
}
...
bool WriteRegister::ShowToolTips()
{
  return true;
}
...
wxBitmap WriteRegister::GetBitmapResource( const wxString& name )
{
  // Bitmap retrieval
////@begin WriteRegister bitmap retrieval
  wxUnusedVar(name);
  return wxNullBitmap;
////@end WriteRegister bitmap retrieval
}
...
wxIcon WriteRegister::GetIconResource( const wxString& name )
{
  // Icon retrieval
////@begin WriteRegister icon retrieval
  wxUnusedVar(name);
  ...
  return wxNullIcon;
////@end WriteRegister icon retrieval
}
