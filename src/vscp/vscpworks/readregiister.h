...
#ifndef _READREGIISTER_H_
#define _READREGIISTER_H_

#if defined(__GNUG__) && !defined(NO_GCC_PRAGMA)
#pragma interface "readregiister.h"
#endif
...
#define SYMBOL_READREGIISTER_STYLE wxCAPTION|wxRESIZE_BORDER|wxSYSTEM_MENU|wxCLOSE_BOX|wxTAB_TRAVERSAL
