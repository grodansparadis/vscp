...
/*!
* Control creation for frmMainNoMidi
*/
...
{    
  ...
  itemMenu3->AppendSeparator();
  itemMenu3->Append(ID_MENUITEM_MERLIN, _("Merlin..."), wxEmptyString, wxITEM_NORMAL);
  itemMenu3->AppendSeparator();
  ...
  itemMenu13->Append(ID_MENUITEM_CONFIGURATION, _("Configuration..."), wxEmptyString, wxITEM_NORMAL);
  itemMenu13->AppendSeparator();
  itemMenu13->Append(ID_MENUITEM_MDF_EDITOR, _("MDF Editor"), wxEmptyString, wxITEM_NORMAL);
  menuBar->Append(itemMenu13, _("Tools"));
  wxMenu* itemMenu17 = new wxMenu;
  itemMenu17->Append(ID_MENUITEM33, _("VSCP-Works Help"), wxEmptyString, wxITEM_NORMAL);
  itemMenu17->Append(ID_MENUITEM34, _("Frequently Asked Questions"), wxEmptyString, wxITEM_NORMAL);
  itemMenu17->Append(ID_MENUITEM35, _("Keyboard shortcuts"), wxEmptyString, wxITEM_NORMAL);
  itemMenu17->AppendSeparator();
  itemMenu17->Append(ID_MENUITEM_THANKS, _("Thanks..."), wxEmptyString, wxITEM_NORMAL);
  itemMenu17->Append(ID_MENUITEM_CREDITS, _("Credits..."), wxEmptyString, wxITEM_NORMAL);
  itemMenu17->AppendSeparator();
  itemMenu17->Append(ID_MENUITEM_VSCP_SITE, _("Go to VSCP site"), wxEmptyString, wxITEM_NORMAL);
  itemMenu17->AppendSeparator();
  itemMenu17->Append(ID_MENUITEM_ABOUT, _("About"), wxEmptyString, wxITEM_NORMAL);
  menuBar->Append(itemMenu17, _("Help"));
  itemFrame1->SetMenuBar(menuBar);

  wxStatusBar* itemStatusBar28 = new wxStatusBar;
  itemStatusBar28->Create( itemFrame1, ID_STATUSBAR, wxST_SIZEGRIP|wxNO_BORDER );
  itemStatusBar28->SetFieldsCount(2);
  itemFrame1->SetStatusBar(itemStatusBar28);

  wxToolBar* itemToolBar29 = CreateToolBar( wxTB_FLAT|wxTB_HORIZONTAL|wxTB_NODIVIDER, ID_TOOLBAR );
  wxBitmap itemtool30Bitmap(itemFrame1->GetBitmapResource(wxT("open.xpm")));
  wxBitmap itemtool30BitmapDisabled;
  itemToolBar29->AddTool(ID_TOOL, wxEmptyString, itemtool30Bitmap, itemtool30BitmapDisabled, wxITEM_NORMAL, wxEmptyString, wxEmptyString);
  itemToolBar29->Realize();
  itemFrame1->SetToolBar(itemToolBar29);

  wxPanel* itemPanel31 = new wxPanel;
  itemPanel31->Create( itemFrame1, ID_PANEL1, wxDefaultPosition, wxDefaultSize, wxSUNKEN_BORDER|wxTAB_TRAVERSAL );
  itemPanel31->SetBackgroundColour(wxColour(255, 255, 255));

  wxBoxSizer* itemBoxSizer32 = new wxBoxSizer(wxVERTICAL);
  itemPanel31->SetSizer(itemBoxSizer32);

  wxStaticBitmap* itemStaticBitmap33 = new wxStaticBitmap;
  itemStaticBitmap33->Create( itemPanel31, wxID_STATIC, itemFrame1->GetBitmapResource(wxT("../../../docs/vscp/logo/vscp_logo.jpg")), wxDefaultPosition, wxSize(151, 212), 0 );
  itemStaticBitmap33->SetBackgroundColour(wxColour(255, 255, 255));
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// wxEVT_COMMAND_MENU_SELECTED event handler for ID_MENUITEM36
//
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// wxEVT_COMMAND_MENU_SELECTED event handler for ID_MENUITEM37
//
...
{
    //DeviceBootloaderwizard dlg( this );
...
{
////@begin wxEVT_COMMAND_MENU_SELECTED event handler for ID_MENUITEM_MERLIN in frmMain.
