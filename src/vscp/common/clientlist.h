...
enum {
	...
	CLIENT_ITEM_INTERFACE_TYPE_CLIENT_INTERNAL,
	CLIENT_ITEM_INTERFACE_TYPE_DRIVER_CANAL,
	CLIENT_ITEM_INTERFACE_TYPE_DRIVER_VSCP,
	CLIENT_ITEM_INTERFACE_TYPE_CLIENT_TCPIP,
	CLIENT_ITEM_INTERFACE_TYPE_CLIENT_UDP,
	CLIENT_ITEM_INTERFACE_TYPE_CLIENT_WEB,
	CLIENT_ITEM_INTERFACE_TYPE_CLIENT_WEBSOCKET,
    CLIENT_ITEM_INTERFACE_TYPE_CLIENT_REST
};
...
#define CLIENT_ITEM_INTERFACE_TYPE_CLIENT_WEB			5
#define CLIENT_ITEM_INTERFACE_TYPE_CLIENT_WEBSOCKET     6
*/
