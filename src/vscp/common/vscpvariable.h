...
public:
  ...
  */
  void setPersistatValue( const wxString& str ) { m_persistant = str; };
  ...
  */
  void setValue( wxString& val ) { m_strValue = val; };

  /*!
    getValue
    @param value String that will receive value.
  */
  void getValue( wxString *pValue ) { *pValue = m_strValue; };

  /*!
    setValue
    @param val long to set value to.
  */
  void setValue( int val ) { m_longValue = val; };

  /*!
    getValue
    @param value Int that will receive value.
  */
  void getValue( int *pValue ) { *pValue = m_longValue; };

  /*!
    setValue
    @param val double to set value to.
  */
  void setValue( double val ) { m_floatValue = val; };

  /*!
    getValue
    @param value Double that will receive the value.
  */
  void getValue( double *pValue ) { *pValue = m_floatValue; };


  /*!
    setValue
    @param val Bool to set value to.
  */
  void setValue( bool val ) { m_boolValue = val; };

  /*!
    getValue
    @param value Bool that will receive the value.
  */
  void getValue( bool *pValue ) { *pValue = m_boolValue; };
...
public:
  ...
  */
  ...
  unsigned char       m_normalizedIntCode;            // Normalized int code stored here, value in same as long		
  uint8_t             m_normInteger[8];
