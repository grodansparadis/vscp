...
class vscpClientWs2 : public CVscpClient
{
...
public:
    ...
    */
    virtual int init(const std::string host,
                    ...
                    uint8_t *vscpkey,
                    uint32_t connection_timeout = WS2_CONNECTION_TIMEOUT,
                    uint32_t response_timeout = WS2_RESPONSE_TIMEOUT );
    ...
    */
    int waitForResponse( uint32_t timeout = WS2_RESPONSE_TIMEOUT );
