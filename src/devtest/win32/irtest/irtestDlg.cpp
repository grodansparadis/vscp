// irtestDlg.cpp : implementation file
//
...
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CIrtestDlg)
	DDX_Text(pDX, IDC_EDIT1, m_EditCtrl);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CIrtestDlg, CDialog)
	//{{AFX_MSG_MAP(CIrtestDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
